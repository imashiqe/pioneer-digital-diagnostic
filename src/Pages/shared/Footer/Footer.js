...
const Footer = () => {
  ...
  <div>
    <span className="footer-title">Facebook</span> 

    <span className="footer-title">Contact</span> 
   
   <h4>সোনামিয়া মার্কেট কলেজ রোড সানারপাড় সিদ্ধিরগঞ্জ নারায়ণগঞ্জ</h4>
   <h4>Mobile: +88 01889991000, +88 01755501099</h4>
   <h4>E-mail: info@pioneerhsbd.com</h4>
   <h4>Facebook: Pioneer Digital Diagnostic</h4>
   <h4>Skype ID: pioneerhsbd Web: www.pioneerhsbd.com</h4>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>Pioneer Digital Diagnostic <br/> Developed By <a href='https://www.gnexer.com/' >Gnexer</a></p>
  </div> 
